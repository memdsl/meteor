...
trait ConfigInst extends ConfigIO {
    ...
    val ALU_TYPE_MULSU = 19.U(SIGS_WIDTH.W)
    val ALU_TYPE_MULU  = 20.U(SIGS_WIDTH.W)
    val ALU_TYPE_DIV   = 21.U(SIGS_WIDTH.W)
    val ALU_TYPE_DIVU  = 22.U(SIGS_WIDTH.W)
    val ALU_TYPE_REM   = 23.U(SIGS_WIDTH.W)
    val ALU_TYPE_REMU  = 24.U(SIGS_WIDTH.W)
    val ALU_TYPE_SLLW  = 25.U(SIGS_WIDTH.W)
    val ALU_TYPE_SRLW  = 26.U(SIGS_WIDTH.W)
    val ALU_TYPE_SRLIW = 27.U(SIGS_WIDTH.W)
    val ALU_TYPE_SRAW  = 28.U(SIGS_WIDTH.W)
    val ALU_TYPE_SRAIW = 29.U(SIGS_WIDTH.W)
    val ALU_TYPE_DIVW  = 30.U(SIGS_WIDTH.W)
    val ALU_TYPE_DIVUW = 31.U(SIGS_WIDTH.W)
    val ALU_TYPE_REMW  = 32.U(SIGS_WIDTH.W)
