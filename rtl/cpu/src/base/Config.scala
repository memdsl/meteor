...
trait ConfigInstPattern extends ConfigInst {
    val INST_SLL    = BitPat("b0000000_?????_?????_001_?????_01100_11")
    val INST_SLLI   = BitPat("b000000?_?????_?????_001_?????_00100_11")
    val INST_SRLI   = BitPat("b000000?_?????_?????_101_?????_00100_11")
    val INST_SRA    = BitPat("b0100000_?????_?????_101_?????_01100_11")
    val INST_SRAI   = BitPat("b010000?_?????_?????_101_?????_00100_11")
    val INST_SLLW   = BitPat("b0000000_?????_?????_001_?????_01110_11")
    val INST_SLLIW  = BitPat("b0000000_?????_?????_001_?????_00110_11")
    val INST_SRLW   = BitPat("b0000000_?????_?????_101_?????_01110_11")
    val INST_SRLIW  = BitPat("b0000000_?????_?????_101_?????_00110_11")
    val INST_SRAW   = BitPat("b0100000_?????_?????_101_?????_01110_11")
    val INST_SRAIW  = BitPat("b0100000_?????_?????_101_?????_00110_11")

    val INST_ADD    = BitPat("b0000000_?????_?????_000_?????_01100_11")
    val INST_ADDI   = BitPat("b???????_?????_?????_000_?????_00100_11")
    val INST_SUB    = BitPat("b0100000_?????_?????_000_?????_01100_11")
    val INST_LUI    = BitPat("b???????_?????_?????_???_?????_01101_11")
    val INST_AUIPC  = BitPat("b???????_?????_?????_???_?????_00101_11")
    val INST_ADDW   = BitPat("b0000000_?????_?????_000_?????_01110_11")
    val INST_ADDIW  = BitPat("b???????_?????_?????_000_?????_00110_11")
    val INST_SUBW   = BitPat("b0100000_?????_?????_000_?????_01110_11")

    val INST_XOR    = BitPat("b???????_?????_?????_100 ?????_01100_11")
    val INST_XORI   = BitPat("b???????_?????_?????_100_?????_00100_11")
    val INST_OR     = BitPat("b0000000_?????_?????_110_?????_01100_11")
    val INST_ORI    = BitPat("b???????_?????_?????_110_?????_00100_11")
    val INST_AND    = BitPat("b0000000_?????_?????_111_?????_01100_11")
    val INST_ANDI   = BitPat("b???????_?????_?????_111_?????_00100_11")

    val INST_SLT    = BitPat("b0000000_?????_?????_010_?????_01100_11")
    val INST_SLTU   = BitPat("b0000000_?????_?????_011_?????_01100_11")
    val INST_SLTIU  = BitPat("b???????_?????_?????_011_?????_00100_11")

    val INST_BEQ    = BitPat("b???????_?????_?????_000_?????_11000_11")
    val INST_BNE    = BitPat("b???????_?????_?????_001_?????_11000_11")
    val INST_BLT    = BitPat("b???????_?????_?????_100_?????_11000_11")
    val INST_BGE    = BitPat("b???????_?????_?????_101_?????_11000_11")
    val INST_BLTU   = BitPat("b???????_?????_?????_110_?????_11000_11")
    val INST_BGEU   = BitPat("b???????_?????_?????_111_?????_11000_11")

    val INST_JAL    = BitPat("b???????_?????_?????_???_?????_11011_11")
    val INST_JALR   = BitPat("b???????_?????_?????_000_?????_11001_11")

    val INST_LB     = BitPat("b???????_?????_?????_000_?????_00000_11")
    val INST_LH     = BitPat("b???????_?????_?????_001_?????_00000_11")
    val INST_LBU    = BitPat("b???????_?????_?????_100_?????_00000_11")
    val INST_LHU    = BitPat("b???????_?????_?????_101_?????_00000_11")
    val INST_LW     = BitPat("b???????_?????_?????_010_?????_00000_11")
    val INST_LWU    = BitPat("b???????_?????_?????_110_?????_00000_11")
    val INST_LD     = BitPat("b???????_?????_?????_011_?????_00000_11")

    val INST_SB     = BitPat("b???????_?????_?????_000_?????_01000_11")
    val INST_SH     = BitPat("b???????_?????_?????_001_?????_01000_11")
    val INST_SW     = BitPat("b???????_?????_?????_010_?????_01000_11")
    val INST_SD     = BitPat("b???????_?????_?????_011_?????_01000_11")

    val INST_ECALL  = BitPat("b0000000_00000_00000_000_00000_11100_11")
    val INST_EBREAK = BitPat("b0000000_00001_00000_000_00000_11100_11")

    val INST_SRRW  = BitPat("b???????_?????_?????_001_?????_11100_11")
    val INST_SRRS  = BitPat("b???????_?????_?????_010_?????_11100_11")
    val INST_RET   = BitPat("b0011000_00010_00000_000_00000_11100_11")

    val INST_MUL    = BitPat("b0000001_?????_?????_000_?????_01100_11")
    val INST_MULW   = BitPat("b0000001_?????_?????_000_?????_01110_11")
    val INST_DIVU   = BitPat("b0000001_?????_?????_101_?????_01100_11")
    val INST_DIVW   = BitPat("b0000001_?????_?????_100_?????_01110_11")
    val INST_DIVUW  = BitPat("b0000001_?????_?????_101_?????_01110_11")
    val INST_REMU   = BitPat("b0000001_?????_?????_111_?????_01100_11")
    val INST_REMW   = BitPat("b0000001_?????_?????_110_?????_01110_11")
}
