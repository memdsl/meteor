...
trait ConfigInst extends ConfigIO {
    ...
    val ALU_RS2_CSR   = 2.U(SIGS_WIDTH.W)
    val ALU_RS2_IMM_I = 3.U(SIGS_WIDTH.W)
    val ALU_RS2_IMM_S = 4.U(SIGS_WIDTH.W)
    val ALU_RS2_IMM_B = 5.U(SIGS_WIDTH.W)
    val ALU_RS2_IMM_U = 6.U(SIGS_WIDTH.W)
    val ALU_RS2_IMM_J = 7.U(SIGS_WIDTH.W)
    val ALU_RS2_4     = 8.U(SIGS_WIDTH.W)
